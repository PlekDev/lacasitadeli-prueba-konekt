...
// Validate ../../src/app/api/cash-session/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/cash-session">> = Specific
  const handler = {} as typeof import("../../src/app/api/cash-session/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
