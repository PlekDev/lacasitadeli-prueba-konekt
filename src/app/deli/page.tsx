  ...
  return (
    <div className="min-h-screen bg-casita-cream flex flex-col">
      ...
      <main className="flex-1 pt-48 pb-24 px-6 max-w-4xl mx-auto text-center">
        <h1 className="text-6xl font-serif font-bold text-casita-charcoal mb-6">Nuestra Charcutería</h1>
        <p className="text-xl text-muted-foreground mb-12 italic">
          Estamos preparando una selección de los mejores cortes y embutidos artesanales. Próximamente disponible para pedidos online.
        </p>
        <Link href="/market">
